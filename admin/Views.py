...
# Arquivos adicionais de css e js
...
class UserView(ModelView):
    column_exclude_list = ['password'] # Não exibir na listagem
    form_excluded_columns = ['last_update'] # Não exibir na listagem

    # Não exibir ao digitar senha
    form_widget_args = {
        'password': {
            'type': 'password'
        }
